...
function displayResults(data) {
  ...
  data.forEach((place) => {
    ...
    const mapUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(place.name)}+${place.location.lat},${place.location.lng}`;
    ...
    card.innerHTML = `
        ...
        <a href="${mapUrl}" target="_blank">Googleマップで見る</a>
